                            ...
                            public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                                if (permissionDeniedResponse.isPermanentlyDenied()) {
                                    ...
                                    builder.setTitle(R.string.dialog_title)
                                            ...
                                            .setNegativeButton(R.string.dialog_negativeButton, null)
                                            .setPositiveButton(R.string.dialog_positiveButton,
                                    ...
                                    Toast.makeText(PermissionActivity.this, R.string.dialog_title, Toast.LENGTH_SHORT).show();
                                }
                            }
